...
router.patch("/:id/aprovar", authMiddleware, requireTenant, requireAssinaturaAtiva, permissionMiddleware("compras.pedidos.criar"), c.aprovar.bind(c));
router.post("/:id/devolucao", authMiddleware, requireTenant, requireAssinaturaAtiva, permissionMiddleware("compras.pedidos.receber"), c.devolver.bind(c));
